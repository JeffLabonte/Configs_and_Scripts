...
POWERLEVEL9K_CUSTOM_OPENSUSE_ICON="echo $'\uF17C'"
POWERLEVEL9K_CUSTOM_OPENSUSE_ICON_BACKGROUND=067
POWERLEVEL9K_CUSTOM_OPENSUSE_ICON_FOREGROUND=015

POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(custom_opensuse_icon context dir vcs)
