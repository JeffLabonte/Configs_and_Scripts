...
globalkeys = gears.table.join(
    ...
    function () awful.util.spawn("pactl set-sink-volume 0 +5%") end),
    awful.key({ },
    ...
    awful.key({ },
    "XF86MonBrightnessUp",
    function () awful.util.spawn("lux -a 5%") end),
    awful.key({ },
    "XF86MonBrightnessDown",
    function () awful.util.spawn("lux -s 5%") end),
...
awful.util.spawn_with_shell("setxkbmap -layout 'us,ca'")
